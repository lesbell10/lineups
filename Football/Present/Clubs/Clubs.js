...
function updatePlayerInfo() {
    ...
    if (selectedYear == "10") {
        ...
        smallpic.addEventListener('mouseover', () => {
            ...
            sideModal.innerHTML = "Manager: Pep Guardiola <br> Best Player: Erling Haaland <br> Best Ever: Kevin De Bruyne <br> Position Last Year: 1st in Premier League"
        })
    ...
    if (selectedYear == "14") {
        ...
        smallpic.addEventListener('mouseover', () => {
            sideModal.style.display = 'block'
            sideModal.innerHTML = "Manager: Carlo Ancelotti <br> Best Player: Vinicius Jr <br> Best Ever: Zinedine Zidane, Cristiano Ronaldo <br> Position Last Year: 2nd in La Liga"
        })
    ...
    if (selectedYear == "13") {
        ...
        smallpic.addEventListener('mouseover', () => {
            sideModal.style.display = 'block'
            sideModal.innerHTML = "Manager: Luis Enrique <br> Best Player: Kylian Mbappe <br> Best Ever: Zlatan Ibrahimovic <br> Position Last Year: 1st in Ligue 1"
        })
    ...
    if (selectedYear == "5") {
        ...
        smallpic.addEventListener('mouseover', () => {
            sideModal.style.display = 'block'
            sideModal.innerHTML = "Manager: Thomas Tuchel <br> Best Player: Harry Kane <br> Best Ever: Franz Beckenbauer <br> Position Last Year: 1st in Bundesliga"
        })
    ...
    if (selectedYear == "9") {
        ...
        smallpic.addEventListener('mouseover', () => {
            sideModal.style.display = 'block'
            sideModal.innerHTML = "Manager: Jurgen Klopp <br> Best Player: Mohamed Salah <br> Best Ever: Steven Gerrard <br> Position Last Year: 5th in Premier League"
        })
    ...
    if (selectedYear == "4") {
        ...
        smallpic.addEventListener('mouseover', () => {
            sideModal.style.display = 'block'
            sideModal.innerHTML = "Manager: Xavi Hernandez <br> Best Player: Robert Lewandowski <br> Best Ever: Lionel Messi, Ronaldinho, Johan Cruyff <br> Position Last Year: 1st in La Liga"
        })
    ...
    if (selectedYear == "6") {
        ...
        smallpic.addEventListener('mouseover', () => {
            sideModal.style.display = 'block'
            sideModal.innerHTML = "Manager: Mauricio Pochettino <br> Best Player: Raheem Sterling <br> Best Ever: Frank Lampard, Didier Drogba, John Terry <br> Position Last Year: 12th in Premier League"
        })
    ...
    if (selectedYear == "11") {
        ...
        smallpic.addEventListener('mouseover', () => {
            sideModal.style.display = 'block'
            sideModal.innerHTML = "Manager: Erik ten Hag <br> Best Player: Bruno Fernandes <br> Best Ever: Cristiano Ronaldo <br> Position Last Year: 3rd in Premier League"
        })
    ...
    if (selectedYear == "8") {
        ...
        smallpic.addEventListener('mouseover', () => {
            sideModal.style.display = 'block'
            sideModal.innerHTML = "Manager: Massimiliano Allegri <br> Best Player: Federico Chiesa <br> Best Ever: Alessandro Del Piero, Gianluigi Buffon <br> Position Last Year: 7th in Serie A"
        })
    ...
    if (selectedYear == "1") {
        ...
        smallpic.addEventListener('mouseover', () => {
            sideModal.style.display = 'block'
            sideModal.innerHTML = "Manager: Mikel Arteta <br> Best Player: Martin Odegaard <br> Best Ever: Thierry Henry <br> Position Last Year: 2nd in Premier League"
        })
    ...
    if (selectedYear == "7") {
        ...
        smallpic.addEventListener('mouseover', () => {
            sideModal.style.display = 'block'
            sideModal.innerHTML = "Manager: Simone Inzaghi <br> Best Player: Lautaro Martinez <br> Best Ever: Giuseppe Meazza, Javier Zanetti <br> Position Last Year: 3rd in Serie A"
        })
    ...
    if (selectedYear == "3") {
        ...
        smallpic.addEventListener('mouseover', () => {
            sideModal.style.display = 'block'
            sideModal.innerHTML = "Manager: Diego Simeone <br> Best Player: Antoine Griezmann <br> Best Ever: Fernando Torres <br> Position Last Year: 3rd in La Liga"
        })
    ...
    if (selectedYear == "0") {
        ...
        smallpic.addEventListener('mouseover', () => {
            sideModal.style.display = 'block'
            sideModal.innerHTML = "Manager: Stefano Pioli <br> Best Player: Rafael Leao <br> Best Ever: Paolo Maldini, van Basten, Kaka <br> Position Last Year: 4th in Serie A"
        })
    ...
    if (selectedYear == "12") {
        ...
        smallpic.addEventListener('mouseover', () => {
            sideModal.style.display = 'block'
            sideModal.innerHTML = "Manager: Walter Mazzarri <br> Best Player: Victor Osimhen <br> Best Ever: Diego Maradona <br> Position Last Year: 1st in Serie A"
        })
    ...
    if (selectedYear == "15") {
        ...
        smallpic.addEventListener('mouseover', () => {
            sideModal.style.display = 'block'
            sideModal.innerHTML = "Manager: Ange Postecoglou <br> Best Player: Heung-Min Son <br> Best Ever: Harry Kane <br> Position Last Year: 8th in Premier League"
        })
    ...
    if (selectedYear == "2") {
        ...
        smallpic.addEventListener('mouseover', () => {
            sideModal.style.display = 'block'
            sideModal.innerHTML = "Manager: Daniele De Rossi <br> Best Player: Paulo Dybala <br> Best Ever: Francesco Totti, Daniele De Rossi <br> Position Last Year: 6th in Serie A"
        })
